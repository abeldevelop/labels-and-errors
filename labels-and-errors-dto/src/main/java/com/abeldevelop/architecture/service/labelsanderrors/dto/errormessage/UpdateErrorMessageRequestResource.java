...
@ApiModel(description="Update Error Message resource")
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Getter
...
@ToString
public class UpdateErrorMessageRequestResource {
    ...
    @ApiModelProperty(notes="Version of resource", example="1", required = true, position = 4)
    @NotNull
